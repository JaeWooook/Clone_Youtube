...
const handleLoadedMetadata = () => {
  //meta data가 로드되었을 때만, timeline의 max를 가져온다.
...
video.addEventListener("loadeddata", handleLoadedMetadata); //video 메타데이터를 로드한것을 알게되면 ui를 업데이트 해준다.
//video메타데이터는 video들의 정보들이다.
